...
tumblr_blog = 'nicolebrian2015.tumblr.com' # change to your tumblr page
addr_to   = 'ayr7sjre8dmaj@tumblr.com' # The special tumblr auto post email address
addr_from = 'photoboothuploads@gmail.com' # change to your full gmail address
user_name = 'photoboothuploads' # change to your gmail username
password = 'weddingsaregreat!' # change to your gmail password
...
def start_photobooth(): 
	...
	# #print "trying to find the start jpg."
	# #os.rename(file_path + "1.jpg", file_path + now + ".jpg")

	#With Camera: Taking Pics
	print "Taking pics" 
	now = time.strftime("%Y%m%d%H%M%S") #get the current date and time for the start of the filename
	try: #take the photos
	...
	#graphicsmagick = "gm convert -delay " + str(gif_delay) + " " + file_path + "img"+ "*.jpg " + file_path + now + ".gif" 
